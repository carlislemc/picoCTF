...
class FlaskApp(WebService):
    ...
    def flask_setup(self):
        ...
        #self.start_cmd = "python3 -m {} -d {} ".format(http_server,self.directory)
        self.start_cmd = "python3 {}/{} ".format(self.directory,"server.py")
        print(self.start_cmd)
        #self.start_cmd = "python3 -m {} -d {}".format(http_server,self.app_file)
...
class PHPApp(WebService):
    ...
    def php_setup(self):
        ...
        self.start_cmd = "php -t {} -S 0.0.0.0:".format(web_root)
